        ...
        <div className="px-6 pt-6 lg:px-8">
            <div>
                ...
                >
                    ...
                    <div className="hidden lg:flex min-w-0 lg:flex-1 lg:grow lg:justify-end lg:gap-3">
                        <a
                            href="login"
                    ...
                    >
                        ...
                        <div className="mt-12 flow-root">
                            <div className="-my-6 divide-y divide-gray-500/10">
                                <div className="space-y-2 py-56">
                                    {navigation.map((item) => (
                                        <a
                                            key={item.name}
                                            href={item.href}
                                            className="-mx-3 block rounded-lg py-2 px-3 text-base sm:text-lg text-center font-semibold leading-7 text-gray-900 hover:bg-gray-400/10"
                                        >
                                            {item.name}
                                        </a>
                                    ))}
