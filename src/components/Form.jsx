...
export default function Form() {
  return (
    <div className="mx-auto max-w-md sm:max-w-3xl">
      ...
      <div className="mt-10">
        <h3 className="text-sm font-medium text-gray-500">Recommended image descriptions</h3>
              ...
              >
                <span className="flex min-w-0 flex-1 items-center space-x-3">
                  ...
                  <span className="block min-w-0 flex-1">
                    ...
                    <span className="block truncate text-sm font-medium text-gray-500">{person.user}</span>
                  </span>
                </span>
