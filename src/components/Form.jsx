    ...
    return (
        <div className="mx-auto max-w-md sm:max-w-3xl">
                ...
                <form className="form mt-6 sm:flex sm:items-center">
                    ...
                    <div className="mt-3 sm:mt-0 sm:ml-4 sm:flex-shrink-0">
                        <button
                            ...
                            className="submit block w-full rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-center text-sm font-medium text-white shadow-sm transition-all hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                        >
                            Generate
                        </button>
                    </div>
            ...
            <div className="mt-10">
                ...
                <ul
                    role="list"
                    className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-1"
                >
